...
The TDD app is designed with the principle of creating a test before developing the program.
...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/Kccendana/TDD.git
   ```
...
Feel free to check the [issues page](https://github.com/Kccendana/TDD/issues).
